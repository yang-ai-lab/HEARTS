...
📄 **[Paper](https://arxiv.org/abs/2603.06638)** | 🌐 **[Website](https://yang-ai-lab.github.io/HEARTS)** | 🤗 **[Data](https://huggingface.co/datasets/yang-ai-lab/HEARTS)** | 🏃 **[Quickstart](#-quickstart-frozen-eval)** | ⚙️ **[Configuration](#-configuration)** | 🧪 **[Experiments](#-experiments)** | 🕵️ **[Agents](#-agents)** | 📚 **[Citation](#-citation)**
